...
class Country_ViewModel {
    ...
    func mealSearchResults(searchText: String) -> [Meal] {
        print(searchText)
            ...
            countries.forEach { country in
                country.meals.forEach { meal in
                    if meal.name_meal.lowercased().contains(searchText.lowercased()) {
                        meals.append(meal) // Only append matching meals
                    }
                }
            }
